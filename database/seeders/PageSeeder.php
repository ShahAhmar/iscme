            ...
            <div class="container position-relative z-1 text-white py-5">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 mt-5 mt-lg-0 text-lg-end" data-aos="fade-left" data-aos-delay="300">
                        <div class="d-inline-block p-4 rounded-4 w-100" style="background: rgba(255,255,255,0.12); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); border: 1px solid rgba(255,255,255,0.35); box-shadow: 0 8px 32px rgba(0,0,0,0.15); position: relative; overflow: hidden; z-index: 1;">
